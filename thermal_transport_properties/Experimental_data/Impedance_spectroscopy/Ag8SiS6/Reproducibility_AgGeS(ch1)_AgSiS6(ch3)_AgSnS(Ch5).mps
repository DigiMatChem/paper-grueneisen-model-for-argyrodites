...
Grouped channel(s) : 1, 3, 5

EC-LAB for windows v11.52 (software)
Internet server v11.52 (firmware)
Command interpretor v11.52 (firmware)

Filename : C:\Users\AKZMESS001\Documents\EC-Lab\Data\Anupama\Reproducibility_AgGeS(ch1)_AgSiS6(ch3)_AgSnS(Ch5)\Reproducibility_AgGeS(ch1)_AgSiS6(ch3)_AgSnS(Ch5).mps
...
Temp List (°C)      25/-40/-30/-20/-10/0.0/10/20/25/30/40
Stab. deltaT (°C)   0,5
Stab. dT/dt (°C/mn) 0,2
Stab. tmax (s)      3600
